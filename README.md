...
[Фронтенд-документация](#фронтенд-документация)
...
* TEMPORARY – внутри лежит тестовый экран авторизации для того, чтобы заходить в приложение локально. Логин: client, пароль: Client1\! Либо логин: trainer, пароль: Trainer1\!
