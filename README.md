...
3. Когда очень спешили, этим правилам не следовали, поэтому коду требуется хороший рефакторинг.
4. Важные качества приложения: адаптивность и цифровая доступность (закрыты все критерии доступности по WCAG минимум на уровень А, многие на АА, некоторые даже на ААА). Пожалуйста, старайтесь поддерживать приложение по-прежнему адаптивным и доступным.
5. ❤️❤️❤️
...
* Логин: client2, пароль: Client1\! – для клиента (есть ещё логин client, но он немного сломанный).
